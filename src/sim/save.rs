...
/// per-cell biome and the per-cell region map (biomes as regions); version
/// 9 added the waterfall list (river morphology); version 10 added the
/// world's geological history and the ecology warm-up parameter.
