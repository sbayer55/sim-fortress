...
dialog, the title menu, Load World, S14, S15, the S01 compact overlay sidebar and
the planned S16 ([spec](../screens/s16-top-dynasties.md), which adds a Race Chart sheet)
