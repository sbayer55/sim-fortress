...
| `s` `g` `t` `d` `y` `e` `l` | species, graphs, traits & fates, top dynasties, ecology, events, lineage | [S04](s04-species-browser.md), [S05](s05-population-charts.md), [S15](s15-traits-fates.md), [S16](s16-top-dynasties.md), [S06](s06-ecology.md), [S07](s07-event-log.md), [S08](s08-lineage.md) |
