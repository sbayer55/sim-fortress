...
soil moisture lie, or how far a chosen predator can perceive. Overlays are a *state* of the
...
`sense range` so the active overlay is named even when the sidebar is collapsed.
