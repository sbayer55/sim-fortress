...
| S02 | Map Overlay               | [s02-map-overlay.md](s02-map-overlay.md)       | a: vegetation · b: pressure · c: moisture · d: sense range      |
...
flowchart TD
    ...
    S02["S02 Map Overlay<br/>a veg · b pressure · c moisture · d sense"]
    S13["S13 Local Zoom"]
